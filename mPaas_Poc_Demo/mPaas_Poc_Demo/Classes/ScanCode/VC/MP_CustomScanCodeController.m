...
@interface MP_CustomScanCodeController ()

@end

@implementation MP_CustomScanCodeController
...
- (void)viewDidLoad {
    ...
    self.title = @"扫码";
    // 自定义扫码界面大小
    CGRect rect = [MP_CustomScanCodeController constructScanAnimationRect];
